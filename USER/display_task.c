...
void show_fp_id_result(uint8_t result)
{
    ...
    else
    {
        ...
        display_str_info->content[DISPLAY_ID_FP_ID_SUCCESS].str_len = sizeof("Ö¸ÎÆ²»Æ¥Åä,½öÊÚÈ¨ÍõÒ½Éú¿ÉÒÔ´ò¿ª");
        memcpy(display_str_info->content[DISPLAY_ID_FP_ID_SUCCESS].str, "Ö¸ÎÆ²»Æ¥Åä,½öÊÚÈ¨ÍõÒ½Éú¿ÉÒÔ´ò¿ª", display_str_info->content[DISPLAY_ID_FP_ID_SUCCESS].str_len);
    }
